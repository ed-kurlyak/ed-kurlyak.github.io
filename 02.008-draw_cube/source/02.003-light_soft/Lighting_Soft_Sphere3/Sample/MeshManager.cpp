...
void CMeshManager::Draw_MeshManager ()
{
    ...
    for (UINT i = 0; i < m_TriangleCount; i++)
    {
		...
		float FallOfStart = 30.0f;
		float FallOfEnd = 90.0f;

		float Att1 = Calc_Attenuation(Dist1, FallOfStart, FallOfEnd);
		float Att2 = Calc_Attenuation(Dist2, FallOfStart, FallOfEnd);
		float Att3 = Calc_Attenuation(Dist3, FallOfStart, FallOfEnd);
