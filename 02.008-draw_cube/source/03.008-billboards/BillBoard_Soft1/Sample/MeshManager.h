...
private:
	...
	//рисуем дерево
	void Draw_Polygon_List_Billboard();

	void Draw_Textured_Triangle(vector3 v0, vector3 v1, vector3 v2);
	...
	list m_PolygonsBillboard;
	list m_TransformedPolyBillboard;
